...
粮食采购不是单点比价问题。行情、粮源、物流、资金、成本和履约风险相互影响，传统流程常见信息分散、反复沟通、经验依赖个人、方案依据难追溯等问题。粮达e销 以“粮掌柜 + 六位专业小二”为业务入口，把自然语言需求拆成可执行任务，在关键节点保留人工确认，并持续复用企业历史经验。
...
- [产品设计文档 V2](docs/粮达e销产品设计文档-V2.md)
